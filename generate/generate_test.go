		...
		t.Run(sourceFilename, func(t *testing.T) {
			generated, err := Generate(&Config{
				...
				Bindings: map[string]*TypeBinding{
					"ID":       {Type: "github.com/brody192/genqlient/internal/testutil.ID"},
					...
					"Pokemon": {
						Type:              "github.com/brody192/genqlient/internal/testutil.Pokemon",
						ExpectExactFields: "{ species level }",
					},
					"PokemonInput": {Type: "github.com/brody192/genqlient/internal/testutil.Pokemon"},
				},
...
func TestGenerateWithConfig(t *testing.T) {
	tests := []struct {
		...
		{"CustomContext", "", nil, &Config{
			ContextType: "github.com/brody192/genqlient/internal/testutil.MyContext",
		}},
		{"CustomContextWithAlias", "", nil, &Config{
			ContextType: "github.com/brody192/genqlient/internal/testutil/junk---fun.name.MyContext",
		}},
		...
		{"PackageBindings", "", nil, &Config{
			PackageBindings: []*PackageBinding{
				{Package: "github.com/brody192/genqlient/internal/testutil"},
			},
		}},
		...
		{"ClientGetter", "", nil, &Config{
			ClientGetter: "github.com/brody192/genqlient/internal/testutil.GetClientFromContext",
		}},
		{"ClientGetterCustomContext", "", nil, &Config{
			ClientGetter: "github.com/brody192/genqlient/internal/testutil.GetClientFromMyContext",
			ContextType:  "github.com/brody192/genqlient/internal/testutil.MyContext",
		}},
		{"ClientGetterNoContext", "", nil, &Config{
			ClientGetter: "github.com/brody192/genqlient/internal/testutil.GetClientFromNowhere",
			ContextType:  "-",
		}},
		...
		{"OptionalGeneric", "", []string{"ListInput.graphql", "QueryWithSlices.graphql"}, &Config{
			Optional:            "generic",
			OptionalGenericType: "github.com/brody192/genqlient/internal/testutil.Option",
		}},
